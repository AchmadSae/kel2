...
public class PoliGigi extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        nama_dokter.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-", "Yahya Syafrudin", "Nizam", "Puji Astuti", "Ibnu Batutah" }));
        ...
        jLabel3.setText("input ID dengan awalan \" PG  \" dan \" angka\"");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(id_poligigi, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
...
//        if(rjk1.isSelected()){jenis = "laki laki";}else{jenis = "Perempuan";}
    ...
    private void Hapus1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Hapus1ActionPerformed
         ...
         if (ok==0){
             String sql = "delete from rm_poliumum where id_poliumum ='"+id_poligigi.getText()+"'";
             try{
                PreparedStatement stat = Conn.prepareStatement(sql);
                stat.executeUpdate();
